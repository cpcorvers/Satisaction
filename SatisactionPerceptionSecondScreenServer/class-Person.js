/// CLASS PERSON FROM THIS POINT
// COPY FROM APP SatisactionPerceptionBoard
...
class Person { // class
  ...
  void giveIdentity() {
    if (pawn_polarity == 0) {
      if (pawn_intensity > 0 && pawn_intensity <= 10) {
        identity = 1;
      } else if (pawn_intensity > 10 && pawn_intensity <= 15) {
        identity = 2;
      } else if (pawn_intensity > 15 && pawn_intensity <= 30) {
        identity = 3;
      } else if (pawn_intensity > 30 && pawn_intensity <= 40) {
        identity = 4;
      } else if (pawn_intensity > 40 && pawn_intensity <= 50) {
        identity = 5;
      }
    } else if (pawn_polarity == 1) {
      if (pawn_intensity > 0 && pawn_intensity <= 4) {
        identity = 49;
      } else if (pawn_intensity > 4 && pawn_intensity <= 7) {
        identity = 50;
      } else if (pawn_intensity > 7 && pawn_intensity <= 10) {
        identity = 51;
      } else if (pawn_intensity > 10 && pawn_intensity <= 15) {
        identity = 52;
      } else if (pawn_intensity > 15 && pawn_intensity <= 30) {
